                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <form action="/danh-muc/updateDanhMuc/${detailDanhMuc.id}" method="post">
                                        <div class="mb-3">
                                            <label for="maDanhMuc" class="form-label">Mã danh mục</label>
                                            <input type="text" class="form-control" value="${detailDanhMuc.ma_danh_muc}"
                                                   name="ma_danh_muc" id="maDanhMuc" placeholder="Nhập mã danh mục">
                                        </div>
                                        <div class="mb-3">
                                            <label for="tenDanhMuc" class="form-label">Tên danh mục</label>
                                            <input type="text" class="form-control"
                                                   value="${detailDanhMuc.ten_danh_muc}" name="ten_danh_muc"
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                       name="trang_thai"
                                                       value="active" ${detailDanhMuc.trang_thai=="active"?"checked":""}>
                                                <label class="form-check-label">
                                                    Active
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                       name="trang_thai"
                                                       value="inactive" ${detailDanhMuc.trang_thai=="inactive"?"checked":""}>
                                                <label class="form-check-label">
                                                    Inactive
                                                </label>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" value="${detailDanhMuc.ngay_tao}"
                                                   name="ngay_tao" id="ngayTao">
                                        </div>
                                        <div class="mb-3">
                                            <label for="ngaySua" class="form-label">Ngày sửa</label>
                                            <input type="date" class="form-control" value="${detailDanhMuc.ngay_sua}"
                                                   name="ngay_sua" id="ngaySua">
                                        </div>
