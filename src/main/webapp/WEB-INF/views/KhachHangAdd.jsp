                                ...
                                <div>
                                    <form action="/khach-hang/add" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ho_ten" id="tenKhachHang"
                                                   placeholder="Nhập họ tên khách hàng">
                                        </div>
                                        <div class="mb-3">
                                            <label for="diaChi" class="form-label">Địa chỉ</label>
                                            <input type="text" class="form-control" name="dia_chi" id="diaChi"
                                                   placeholder="Nhập địa chỉ">
                                        </div>
                                        <div class="mb-3">
                                            <label for="soDienThoai" class="form-label">Số điện thoại</label>
                                            <input type="text" class="form-control" name="sdt" id="soDienThoai"
