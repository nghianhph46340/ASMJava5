                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/khach-hang/add"><button class="btn btn-primary mb-3">Thêm khách hàng</button></a>
                                <div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listKhachHang}" var="lkHang" varStatus="c">
                                            <tr>
                                                <td>${c.count}</td>
                                                <td>${lkHang.ho_ten}</td>
                                                <td>${lkHang.dia_chi}</td>
                                                <td>${lkHang.sdt}</td>
                                                <td>${lkHang.trang_thai}</td>
                                                <td>${lkHang.ngay_tao}</td>
                                                <td>${lkHang.ngay_sua}</td>
                                                <td>
                                                    <a href="/khach-hang/detailKH/${lkHang.id}">
                                                        <button type="submit" class="btn btn-warning">Sửa</button>
                                                    </a>
                                                    <a href="/khach-hang/deleteKH/${lkHang.id}">
                                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Bạn có muốn xoá không')">Xoá</button>
                                                    </a>
                                                </td>
                                            </tr>
                                        </c:forEach>
